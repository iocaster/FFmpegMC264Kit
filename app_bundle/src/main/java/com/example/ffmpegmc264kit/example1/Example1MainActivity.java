...
package com.example.ffmpegmc264kit.example1;
...
import com.example.ffmpegmc264kit.R;
        ...
        implements MC264Encoder.YUVFrameListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_sample1);
...
//        mMC264Encoder.reset();     //Please, call mMC264Encoder.reset() inside onPostExecute() not here
    ...
    private static class MyTask extends AsyncTask<String, Void, Void> {
        private final WeakReference<Example1MainActivity> activityWeakReference;

        MyTask(Example1MainActivity activity) {
